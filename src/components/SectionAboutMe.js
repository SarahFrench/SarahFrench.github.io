    ...
    return (
      <div className="Section">
        ...
        <div>
          ...
          <p>
            For my career change I completed a BCS Level 4 Software Developer apprenticeship while working as a developer. To supplement my back-end focus at work I like to do visual personal
            projects and am recently learning React, among other things.
          </p>
          <p>
            In my current role I have worked on various projects,
